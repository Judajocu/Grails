...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Usuario admin =new Usuario(username: "GioGio", password: springSecurityService.encodePassword("1234")).save(failOnError: true)
        Usuario usuario =new Usuario(username: "JoJo", password: springSecurityService.encodePassword("1234")).save(failOnError: true)
